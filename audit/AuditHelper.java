...
public class TibcoAuditHelper {
    ...
    public void sendAudit(Audit audit) {
        try {
            // Vous pouvez choisir d'envoyer l'objet directement ou marshallé
    ...
    /**
     * Extrait les champs communs du ProcessContext
     */
    private ProcessContext extractProcessContext(Exchange exchange) {
        ...
        if (ctx == null) {
            ...
            // Extraire des infos de la route
    ...
    public static class AuditBuilder {
        ...
        public void send() {
            ...
            ProcessContext processContext = helper.extractProcessContext(exchange);
