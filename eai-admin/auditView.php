...
// Touche Entrée = ajouter
    ...
    function addTag(tagText) {
      ...
      if (!tagText) return;
      if (selectedFlows.indexOf(tagText) !== -1) return; // éviter doublons
...
<body>
	<div id="base"> 
		<div class="container-fluid" id="wrapper">
			...
			<div id="main">
				<div id="bigsidebar">
					<form id="auditform" name="auditform" action="AuditController.php" method="post" autocomplete="off" role="form" data-toggle="validator">
						<fieldset class="form-group" style="margin-top:2%;">
							...
							<div class="btn-toolbar pull-right" style="margin-top:5px;">
	    						...
	    						<button class="btn btn-warning round-button" id="g" accesskey="g" name="init" type="submit" value="Effacer" onclick="clearFormInput();"><span class="glyphicon glyphicon-refresh"></span> Réinitialiser</button>
						 	</div>
							<br><br><br>
							<!--<span colspan="2" align="Left">Crit&egrave;res fonctionnels<span style="font-size: 20px;" class="glyphicon glyphicon-plus-sign text-success" onclick="addNewCriteria();" data-toggle="tooltip" data-placement="bottom" title="Ajouter un crit&egrave;re de recherche" ></span></span>-->
							<!--<button title="Ajouter un crit&egrave;re de recherche" class="btn btn-sm btn-primary round-button" type="button" onclick="addNewCriteria();" style="margin-bottom:5px;" data-toggle="tooltip" data-placement="bottom" ><span class="glyphicon glyphicon-filter"></span> Ajouter un critère fonctionnelle</button>-->
				...
				<div id="content">
					...
					<button style="margin-bottom:5px" class="btn btn-success round-button" title="Recharger les données" data-placement="bottom" value="Valider" onclick="refreshPage()"><span class="glyphicon glyphicon-refresh"></span> Rafraîchir</button>
					<!--<button data-toggle="tooltip" data-placement="bottom" title="Rafraîchir" class="btn btn-success" onclick="refreshPage()">
        				<span class="glyphicon glyphicon-refresh"></span>
					</button>-->
					<?php if ($droit->isResendAllowed) { ?>
						<button id="resendMessageButton" data-target="#fenetre-access-action-group" data-toggle="modal" rel="tooltip" data-placement="bottom" title="Renvoyer les données" type="button"  class="btn btn-info round-button" style="margin-bottom:5px;display: none;"><span class="glyphicon glyphicon-play"></span> Renvoyer</button>
					<?php } ?>
	...
	<!---------------------------- PALETTE DETAIL ------------------------------------>
			<div id="fenetre-access-modif-audit" class="modal fade" role="dialog" tabindex='-1'>
					<div class="modal-dialog" style="width: 130%; height: 100%;margin: 0;padding: 0;margin-left: 25%;">
				        	...
				        	<div class="modal-body" style="margin-top:-20px;">
								<div class="formulaire">
										...
										<div class = "tab-pane fade in active" id = "detailsIndented">
											<pre id="detailsContainer" style="overflow-y: scroll;height: 68dvh;resize: none;">
