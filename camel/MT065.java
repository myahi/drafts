...
public class MT065 {
	...
	@DataField(pos = 50, length = 5, trim = false, required = false)
	...
	@DataField(pos = 71, length = 8, trim = false, required = true)
	...
	@DataField(pos = 353, length = 16, trim = false, required = true)
