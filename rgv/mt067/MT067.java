...
@Data
@FixedLengthRecord(length = 241, paddingChar = ' ')
public class MT067 {
    ...
    @DataField(pos = 118, length = 12, trim = false, required = false, align = "L")
    private String F_Code_valeur;

    @DataField(pos = 130, length = 2, trim = false, required = false, align = "L")
    private String F_Zone_reservee_2;

    @DataField(pos = 132, length = 12, trim = false, required = false, align = "L")
    private String F_Code_valeur_fongible;

    @DataField(pos = 144, length = 8, trim = false, required = true, align = "L")
    private String O_Date_rejet;

    @DataField(pos = 152, length = 6, trim = false, required = true, align = "L")
    private String O_Heure_rejet;

    @DataField(pos = 158, length = 3, trim = false, required = true, align = "L")
    private String O_Code_anomalie;

    @DataField(pos = 161, length = 80, trim = false, required = true, align = "L")
    private String O_Libelle_anomalie;
}
