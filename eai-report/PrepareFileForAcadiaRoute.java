        ...
        fromF("file:{{eai.report.acadia.prepare.input.cso.dir}}"
                ...
                .split(body()).stopOnException()
                    ...
                    .process(exchange -> {
                        ...
                        if (inputFile == null) {
                            throw new IllegalStateException("Fichier ICE introuvable dans le split.");
                        }

                        String inputFileName = inputFile.getFileName().toString();

                        // sécurité : on ignore le fichier CSO s'il est dans le même répertoire
