...
public class EmsJmsListener implements MessageListener {
    ...
    public void onMessage(Message msg) {
        ...
        try {
            ...
            // délégation métier (ne connaît pas les queues)
            ...
            // Si tu veux ACK même en erreur (pour éviter redelivery), décommente :
            // try { msg.acknowledge(); } catch (JMSException ignore) {}
        }
    }

    /**
     * API utilisée par le métier : send(type, payload).
